    ...
    <div className="w-custom max-w-custom mx-autoflex flex-col items-center justify-center min-h-screen bg-background">
      <div className="flex-grow flex flex-col items-center">
        <img
          src={errorIcon}
          alt="Error Icon"
          className="w-[180px] h-[180px] mt-[174px] mb-12"
        />
        <h1 className="text-[24px] font-pretendard font-bold text-point500 mb-1">
          일시적인 오류입니다
        </h1>
        <p className="text-[16px] font-pretendard text-gray3">
          잠시 후에 다시 시도해 주세요.
        </p>
      </div>
