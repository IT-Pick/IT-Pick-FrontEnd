...
const AgreementPage: React.FC = () => {
  ...
  return (
    <div
      className="w-custom max-w-custom mx-auto h-screen
     pt-[72px] bg-background font-pretendard"
    >
      ...
      <div className="flex flex-col gap-[24px] mx-[20px]">
        <div className="w-[352px] h-[54px] bg-[#EDF0F3] p-[12px] border border-1 border-[#9EAAB5] rounded-[8px] flex items-center">
          ...
          />
          <div className="text-black text-[16px] font-[700] ml-2">
            아래 약관에 모두 동의합니다.
          </div>
        </div>
        ...
        <div className="w-[334px] flex justify-between items-center ml-[8px]">
          <div className="flex items-center justify-start gap-[12px]">
            <img
              src={
                isAgeChecked ? ico_roundcheck_filled : ico_roundcheck_outline
              }
              alt="check icon"
              className="cursor-pointer"
              onClick={handleAgeCheck}
            />
            <div className="w-[241px] text-black text-[14px] font-[500]">
              [필수] 만 14세 이상이며 이용 약관에 모두 동의합니다.
            </div>
          </div>
          <div
            onClick={() =>
            ...
            className="text-gray3 text-[12px] font-[400] underline cursor-pointer"
          >
            내용 보기
          </div>
        </div>
        ...
        <div className="w-[334px] flex justify-between items-center ml-[8px]">
          <div className="flex items-center justify-start gap-[12px]">
            <img
              src={
                isInfoChecked ? ico_roundcheck_filled : ico_roundcheck_outline
              }
              alt="check icon"
              className="cursor-pointer"
          ...
          <div
            onClick={() =>
              window.open(
                'https://emerald-server-298.notion.site/d2e2565ed7b34bbab37e78f7066c5e16?pvs=4'
              )
            }
            className="text-gray3 text-[12px] font-[400] underline cursor-pointer"
          >
        ...
        <div className="w-[334px] flex justify-between items-center ml-[8px]">
          ...
          <div
            onClick={() =>
              window.open(
                'https://emerald-server-298.notion.site/a2ec6bc8bf534cf3b6e76ee4f94e106b?pvs=4'
              )
            }
            className="text-gray3 text-[12px] font-[400] underline cursor-pointer"
          >
