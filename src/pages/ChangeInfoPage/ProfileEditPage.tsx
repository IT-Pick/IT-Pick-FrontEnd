      ...
      <div className="w-full">
        <div className="mx-6 my-2">
          ...
          <div className="flex justify-between py-3">
            <p className="text-[16px] text-black font-pretendard font-normal">
              생년월일
            </p>
            <p className="text-[14px] text-gray3 font-pretendard font-normal">
          ...
          <div className="flex justify-between py-3">
            <button
              ...
              className="text-[16px] text-black font-pretendard font-normal"
            >
              관심 주제 설정
            </button>
            <p className="text-[14px] text-gray3 font-pretendard font-normal">
