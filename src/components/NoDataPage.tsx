...
const NoDataPage: React.FC<NoDebateProps> = ({ id }) => {
  const nodata = NoData.find((item) => item.id === id);

  return (
    <div className="w-custom max-w-custom mx-auto h-[800px] flex flex-col">
